...
pylinear_mcat = np.genfromtxt(pylinear_mag_file, delimiter=',', dtype=None,
                              names=['segid', 'pylinear_mag'],
                              encoding='ascii')
...
ax.scatter(cat['MAG_AUTO'], pylinear_mcat['pylinear_mag'], s=5,
...
fig.savefig(roman_slitless_dir + 'figures/sextractor_pylinear_mag_compare.pdf',
