...
def main():
    ...
    for e in range(len(exptime_labels)):
        ...
        ax.plot(mags, effective_completeness, 'o-',  markersize=3, 
                color=colors[e])
        ...
        # ax.plot(mags, sigmoid(mags, popt[0], popt[1], popt[2]), 
        #         lw=2.0, color=colors[e])
        ...
        #             label=r'$\frac{\Delta z}{1+z} \leq 0.01$')
        #     ax.plot(mags, pc2, '--', color='k', 
        #             label=r'$\frac{\Delta z}{1+z} \leq 0.001$')
